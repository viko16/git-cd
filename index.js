...
const runClone = repo => execa('ghq', [ 'get', '-p', repo ], shellOpts)
const runHook = repo => (fs.existsSync(hookFile)) ? execa('node', [ hookFile, repo ], shellOpts) : null
const runCd = repo => execa('ghq', [ 'look', repo ], shellOpts)
